...
if(NOT EXISTS ${THIRDPARTY_LIB60870_INCLUDE_DIRS})
	message(FATAL_ERROR "${THIRDPARTY_LIB60870_INCLUDE_DIRS} not exists")
endif()
if(NOT EXISTS ${THIRDPARTY_LIB60870_LIBS})
	message(FATAL_ERROR "${THIRDPARTY_LIB60870_LIBS} not exists")
endif()
